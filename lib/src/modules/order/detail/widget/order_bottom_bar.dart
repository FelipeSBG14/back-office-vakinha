    ...
    return Row(
      ...
      children: [
        OrderBottomBarButton(
          ...
          onPressed: order.stats == OrderStatus.confirmado
        ...
        OrderBottomBarButton(
          ...
          onPressed: order.stats == OrderStatus.pendente
        ...
        OrderBottomBarButton(
          ...
          onPressed: order.stats != OrderStatus.cancelado &&
                  order.stats != OrderStatus.finalizado
